---
title: "Brief your jury: the six-block pack and the 11-minute calibration"
description: "What to send judges before scoring starts — rubric with anchors, scoring procedure, disagreement rule, conflicts of interest, load and schedule, and a recorded calibration."
---
...
**1 · The rubric, with anchors.** Not a list of criterion names. Each dimension needs an anchor description per band, so a judge can tell a 3 from a 7 before the first pitch. The [full pitch rubric with weights and anchors](./criteria-and-weights.md) is published to be dropped straight in.
...
- [Criteria and weights](./criteria-and-weights.md) — the rubric to put in block 1.
- [Score and shortlist](./score-and-shortlist.md) — what judges see when they arrive briefed.
- [Disagreement and spread](../scoring/disagreement-and-spread.md) — the rule to state in block 3.
