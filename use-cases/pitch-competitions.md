---
title: "Running a pitch competition with EvalLens"
description: "How a competition round runs end to end: rubric and tracks locked, entries collected, the written round pre-read, screeners confirm, live rounds unchanged, feedback for every team."
---
...
| Figure | What it is |
|---|---|
| 300+ | Volunteer judges one flagship university competition publicly recruits, every year |
| 4–6 h | The real homework in one screening assignment: three written entries with feedback write-ups |
...
- **On the application form:** plain-language disclosure, so nobody discovers AI involvement after results.
- **On conflicts of interest:** your policy stays your policy. The record simply logs who scored what, which is what makes a recusal verifiable later.

## Two product defaults worth knowing

- A team can request its own record.
- No entry is eliminated without a named human sign-off.

Whether you run open appeals is your policy. The per-entry evidence, scores and decisions make either policy a five-minute conversation.
